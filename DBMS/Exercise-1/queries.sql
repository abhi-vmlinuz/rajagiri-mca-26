...
create table faculty(
	faculty_id char(5) constraint faculty_pkey primary key,
...
create table course(
	...
	course_name varchar2(50) constraint course_name_unique unique not null,
	...
	dept_id varchar2(10) references dept,
	faculty_id char(5) references faculty
);
...
create table event(
	...
	event_date date,
	venue varchar2(50),
	coordinator_faculty_id char(5) references faculty(faculty_id),
