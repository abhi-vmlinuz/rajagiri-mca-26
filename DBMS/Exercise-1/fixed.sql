...
create table product (
    ...
    category_id varchar2(10) constraint prdct_frn_key references category(category_id),
    supplier_id varchar2(10) constraint prdct_frn_key2 references supplier(supplier_id),
    ...
    quantity_available numeric constraint prdct_quantity_check check (quantity_available > 0)
);
...
create table sales_item (
    ...
    selling_price numeric constraint sales_item_selling_check check (selling_price > 0)
);
...
create table payment (
    ...
    payment_mode varchar2(20) constraint payment_mode check (payment_mode in ('CASH','CARD','UPI','BANK_TRANSFER'))
);
