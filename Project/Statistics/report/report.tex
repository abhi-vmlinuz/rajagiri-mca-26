...
P(T < 120) &= 0.093.
\end{align*}
Nearly 23.3\% of all targets fall in the 140--160 band
and a further 38.9\% in the 161--190 band, so a team
setting a target above 190 enters territory reached in only about
9\% of matches. For victory margins, P(margin $>$ 50) =
...
model explains 40.5\% of the variance in seasonal mean targets
...
blow-outs beyond 50 are rare (about 7\% of decided
matches).
